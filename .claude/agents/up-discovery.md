...
Cada POC mora em `runs/<slug>/`, onde `<slug>` e um nome curto em kebab-case da ideia. No inicio da conversa, defina o `<slug>` com o usuario. Todos os artefatos da POC ficam nesse diretorio: `proposal.md`, depois `spec.md` e `qa-verdict.md`.
...
Quando houver comando explicito, escreva `runs/<slug>/proposal.md` usando `templates/proposal.md` como estrutura e mantenha o resultado em aproximadamente uma pagina.
...
Apos o comando explicito: `runs/<slug>/proposal.md` claro, enxuto e pronto para o `@up-spec`.
